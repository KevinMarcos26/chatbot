...
customtkinter.set_appearance_mode("light")  # default value
...
class APP(tk.Tk):
    def __init__(self,*args,**kwargs):
        ...
        self.title("ChatBot - Reto DigitalNao OpenAI")
    ...
    def aviso(self): # ventana emerjente de aviso
        messagebox.showinfo('Documentación de OpenAI','https://openai.com/blog/openai-api')

    def avisoInfo(self): # ventana emerjente de aviso
        messagebox.showinfo('Información del desarrollador','Desarrollado por: Kevin Agui Manera.\nContacto: kevinmarcos2611@gmail.com')
